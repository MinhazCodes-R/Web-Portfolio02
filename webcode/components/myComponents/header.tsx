    ...
    menueitem:(
      ...
      <nav className="flex-grow">
        <ul className="space-y-2 w-[80vw]">
          <li>
            <Link href="./" className="flex items-center space-x-3 p-3 rounded-lg bg-white shadow-sm hover:bg-gray-50 transition-colors duration-200">
              <Home size={24} className="text-black" />
              <span className="font-medium">Home</span>
            </Link>
          </li>
          <li>
            <Link href="./experience" className="flex items-center space-x-3 p-3 rounded-lg bg-white shadow-sm hover:bg-gray-50 transition-colors duration-200">
          ...
          <li>
            <Link href="./projectsdone" className="flex items-center space-x-3 p-3 rounded-lg bg-white shadow-sm hover:bg-gray-50 transition-colors duration-200">
